...
export const UserLogin = async (dispatch, user) => {
  ...
  try {
    const res = await axios.post("https://pastrybox.000webhostapp.com/server/index.php?direct=user", user);
...
export const AddOrder = async (order, dispatch) => {
  ...
  try {
    ...
    await axios.post("https://pastrybox.000webhostapp.com/server/index.php?direct=order", order, config).then((res) => {
...
export const GetOrders = async (dispatch) => {
  ...
  try {
    await axios.get('https://pastrybox.000webhostapp.com/server/index.php?direct=order').then((res) => {
...
export const UpdateOrder = async (orderId, updatedOrder, dispatch) => {
  ...
  try {
    ...
    await axios
      .put(`https://pastrybox.000webhostapp.com/server/index.php?direct=order?id=${orderId}`, updatedOrder, config)
      .then((res) => {
...
export const DeleteOrder = async (id, dispatch) => {
  ...
  try {
    ...
    await axios.delete(`https://pastrybox.000webhostapp.com/server?direct=order?orderid=${id}`, config).then(() => {
